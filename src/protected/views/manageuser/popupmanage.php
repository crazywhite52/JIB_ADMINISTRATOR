    ...
    $(document).ready(function () {
       var getDatamanage = function () {
          var source =
          {
            ...
            url: '<?php echo $this->createUrl("manageuser/dataacc"); ?>',
            updaterow: function (rowid, rowdata, commit) {
                var rows = {};
                rows['menu_name']=true;
                rows['program_id']=$("#program_id").val();
                rows['id']=$("#id").val();
                rows['menu_id']=rowdata.no;
                ...
                //alert($.param(rows));
                $.post('<?php echo $this->createUrl("manageuser/editaccess"); ?>', $.param(rows), function(data, textStatus, xhr) {
                  commit(true);
                  //$("#jqx_acc").jqxGrid({source: getDatamanage()});
              });
            }
        };
